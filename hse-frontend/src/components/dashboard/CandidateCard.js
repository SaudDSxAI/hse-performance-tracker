        ...
        >
            ...
            <div className="flex justify-center mb-4 mt-2">
                <div
                    ...
                    onClick={(e) => { if (onPhotoClick) { e.stopPropagation(); onPhotoClick(e, candidate); } }}
                >
                    <img
                        src={(() => {
                            ...
                            return photo || `https://ui-avatars.com/api/?name=${encodeURIComponent(candidate.name)}&size=150&background=1e3a8a&color=fff`;
                        })()}
                        alt={candidate.name}
